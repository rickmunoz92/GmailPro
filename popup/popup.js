(() => {
  ...
  const controls = {
    ...
    replyAllShortcutEnabled: document.getElementById("reply-all-shortcut"),
    forwardShortcutEnabled: document.getElementById("forward-shortcut"),
  ...
  function values() {
    return {
      ...
      replyAllShortcutEnabled: controls.replyAllShortcutEnabled.checked,
      forwardShortcutEnabled: controls.forwardShortcutEnabled.checked,
