...
window.GmailProTestRow = function row({ unread = false, label = "", attachment = false, sender = "Alex, Morgan 3", subject = "Project update", importance = true, dateTitle = "Mon, Sep 14, 2026, 1:31\u202fPM", dateText = "Sep 14" } = {}) {
